<?php
/**
 * The profile-specific admin functionality of the plugin.
 *
...
/**
 * The profile admin class.
 *
 * Handles all metabox and custom field functionality for the Profile post type.
 *
 * @package    Ecosys_Profile_Manager
 * @subpackage Ecosys_Profile_Manager/admin
 * @author     Ecosys <info@ecosys.io>
 */
class Ecosys_Profile_Manager_Profile_Admin {
